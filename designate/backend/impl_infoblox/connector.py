...
class Infoblox(object):
    ...
    def __init__(self):
        ...
        """
        self.wapi = cfg.CONF['backend:infoblox'].infoblox_wapi
        self.username = cfg.CONF['backend:infoblox'].infoblox_username
        self.password = cfg.CONF['backend:infoblox'].infoblox_password
        self.sslverify = cfg.CONF['backend:infoblox'].infoblox_sslverify
